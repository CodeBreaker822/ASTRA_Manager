...
class AIController extends Controller
{
    ...
    private function cleanAIResponse($response)
    {
        ...
        if (empty($cleanedResponse)) {
            return "I don't have access to system tools yet, so I cannot perform actions. I can only provide general information about the AgSOAR system. Please contact the developers to enable tool access.";
        }
