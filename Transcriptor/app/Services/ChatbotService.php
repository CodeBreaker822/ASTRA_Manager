...
class ChatbotService
{
    ...
    {
        $path = base_path('app/Services/AgsoarSystemPrompt.txt');
        ...
        return 'You are the AgSOAR AI Assistant, the official support assistant for the AgSOAR Information Systems platform. '
            .'Only answer questions about AgSOAR. Provide accurate, concise responses using short paragraphs and bullet points when helpful.';
    }
