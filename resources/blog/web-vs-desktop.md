...
The desktop app is for offline-capable transcription. It can use local Whisper, Silero VAD, and speaker separation features that are not realistic to run inside the SaaS server beta.
