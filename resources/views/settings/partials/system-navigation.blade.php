...
<div class="mb-6 border-b border-gray-200 dark:border-gray-700">
    <nav class="flex flex-wrap gap-4 md:gap-8" aria-label="Tabs">
        ...
        <a href="{{ route('settings.users.index') }}" class="border-b-2 {{ request()->routeIs('settings.users.*') ? 'border-blue-500 text-blue-600 dark:text-blue-400' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 dark:text-gray-400 dark:hover:text-gray-300' }} py-4 px-1 text-sm font-medium whitespace-nowrap">
            {{ __('Users') }}
        </a>
        @endcan
        @can('API-manage_api')
